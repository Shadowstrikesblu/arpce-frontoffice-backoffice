    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
<<<<<<<< HEAD:arpce-homologation-backOffice/Arpce.Homologation.BackOffice/BackOffice.Infrastructure/Migrations/20251202104745_InitialCreate.cs
                    { new Guid("293787e6-f752-4e28-8e3a-670c584c438a"), "Auditeur" },
                    { new Guid("7e5b7d94-4f5d-4eff-9983-c8f846d3cee6"), "Administrateur" },
                    { new Guid("f070e3c6-bd14-445c-ac2e-4ba8da73f5c1"), "Utilisateur Standard" }
========
                    { new Guid("7155e85b-08f3-4cb6-81d5-579e4a7f5899"), "Utilisateur Standard" },
                    { new Guid("7e5b7d94-4f5d-4eff-9983-c8f846d3cee6"), "Administrateur" },
                    { new Guid("b6f56eae-f5ce-4e1e-ba1e-8310b919df55"), "Auditeur" }
>>>>>>>> 29c72a208dcbd6c9b89c6421901fa84af8ef7d95:arpce-homologation-backOffice/Arpce.Homologation.BackOffice/BackOffice.Infrastructure/Migrations/20251202213245_Initialisation.cs
                });
            ...
            migrationBuilder.InsertData(
                ...
                {
<<<<<<<< HEAD:arpce-homologation-backOffice/Arpce.Homologation.BackOffice/BackOffice.Infrastructure/Migrations/20251202104745_InitialCreate.cs
                    { new Guid("12fe3de7-31e8-4bee-b847-038c0d566e6e"), "MobileBanking", null, null, "Paiement mobile", (byte)1, null, null, null },
                    { new Guid("3eab8820-0f36-40df-a1af-7b5b6b1974ef"), "Especes", null, null, "Espèces", (byte)0, null, null, null },
                    { new Guid("5f5ced52-3b65-439c-a3fc-54765a6737e6"), "Cheque", null, null, "Chèque", (byte)0, null, null, null },
                    { new Guid("b979d9a2-69a4-4629-8a02-fe94da3f1f94"), "Virement", null, null, "Virement bancaire", (byte)0, null, null, null }
========
                    { new Guid("07628d0b-c274-4c06-8ba9-fde3a316dc84"), "Virement", null, null, "Virement bancaire", (byte)0, null, null, null },
                    { new Guid("1fb33086-961e-4bae-8295-7b6ec58c06f3"), "Cheque", null, null, "Chèque", (byte)0, null, null, null },
                    { new Guid("64000d39-ae4c-41ef-ad26-473fbe711b45"), "Especes", null, null, "Espèces", (byte)0, null, null, null },
                    { new Guid("b447ece5-d14b-435b-b999-6c83ea24328a"), "MobileBanking", null, null, "Paiement mobile", (byte)1, null, null, null }
>>>>>>>> 29c72a208dcbd6c9b89c6421901fa84af8ef7d95:arpce-homologation-backOffice/Arpce.Homologation.BackOffice/BackOffice.Infrastructure/Migrations/20251202213245_Initialisation.cs
                });
            ...
            migrationBuilder.InsertData(
                ...
                {
<<<<<<<< HEAD:arpce-homologation-backOffice/Arpce.Homologation.BackOffice/BackOffice.Infrastructure/Migrations/20251202104745_InitialCreate.cs
                    { new Guid("04f55720-6254-4155-88c7-8fb1189b105c"), "DossierSigner", "Attestation signée" },
                    { new Guid("051da1c0-f36d-447f-b8b3-a335fa16351b"), "PaiementRejete", "Paiement non accepté" },
                    { new Guid("14fe4c09-9c8f-4c71-b365-a5e1490d4f9e"), "DevisValideSC", "Devis validé par Chef Service" },
                    { new Guid("1694cbad-0fc3-4f5d-b5ed-6d16c62d7d0f"), "RefusDossier", "Refus de la demande" },
                    { new Guid("2a587a06-846f-4f88-bc14-ab7d8bb38f14"), "DevisEmit", "Devis émis" },
                    { new Guid("5b9c2d73-df94-4b44-88dc-5fc5ccd93a11"), "PaiementExpirer", "Paiement expiré" },
                    { new Guid("5fc1d40d-ccd4-43d2-815e-417d3c26c535"), "DevisValide", "Devis validé par client" },
                    { new Guid("7e36dc70-ee33-4ac1-8e14-a98cc56deff8"), "InstructionApprouve", "Instruction Approuvée" },
                    { new Guid("86b5f366-00a0-4746-9d78-c3ebb0348817"), "NouveauDossier", "Nouvelle demande" },
                    { new Guid("8819e7ee-14b8-4dae-95a5-ddb796ab3049"), "DossierPayer", "Paiement effectué" },
                    { new Guid("953bc7af-329d-4d9c-9bd2-5d88791bae7e"), "Instruction", "En cours d'instruction" },
                    { new Guid("a21ca92e-5a69-4d7c-903f-01dfe748a110"), "DevisCreer", "Devis créé" },
                    { new Guid("a8b49a5a-699d-4b9a-99f4-bfd826e73625"), "DossierSignature", "Attestation en signature" },
                    { new Guid("c2e54954-2e89-4231-8365-7910d5a21a49"), "DevisRefuser", "Devis refusé par client" },
                    { new Guid("cae75ba4-9e81-46b2-aaec-5ff6409d96aa"), "DevisValideTr", "Devis validé par Trésorerie" },
                    { new Guid("f1ffe7a4-ed66-466e-95a7-6212fa27cac0"), "ApprobationInstruction", "Envoyé pour approbation" }
========
                    { new Guid("048f9a42-5107-49c3-9d24-2dae0a2898cb"), "DevisValideSC", "Devis validé par Chef Service" },
                    { new Guid("08d8c5e4-0be5-4185-b29e-058f6f6cb99d"), "NouveauDossier", "Nouvelle demande" },
                    { new Guid("311e4102-4b53-486a-8169-2e8e5bf5eb7c"), "DevisValideTr", "Devis validé par Trésorerie" },
                    { new Guid("4e419ee9-1d27-4a2b-9e0b-b2fe46b44125"), "PaiementExpirer", "Paiement expiré" },
                    { new Guid("60b57c73-f261-4233-a488-308114f07cbf"), "DossierSigner", "Attestation signée" },
                    { new Guid("7c0e1236-ff81-4c74-9006-fab8670a5460"), "RefusDossier", "Refus de la demande" },
                    { new Guid("a772fcea-d134-4eed-a0f3-1bfb36d76282"), "InstructionApprouve", "Instruction Approuvée" },
                    { new Guid("a7ff862a-d81d-4a61-b83b-be5907d78304"), "PaiementRejete", "Paiement non accepté" },
                    { new Guid("b9701311-dd3c-4943-ab4a-16257882cdd5"), "ApprobationInstruction", "Envoyé pour approbation" },
                    { new Guid("c799d816-40bb-477a-a859-4b4404cb8e76"), "DevisEmit", "Devis émis" },
                    { new Guid("c7bf5de4-8116-4f4d-ada9-19e989f47802"), "DevisCreer", "Devis créé" },
                    { new Guid("cc2d7826-368f-4f69-a42e-a4e45c550d9c"), "DossierSignature", "Attestation en signature" },
                    { new Guid("d2ba611e-f001-4c87-a8b0-a706cdeb58d2"), "DossierPayer", "Paiement effectué" },
                    { new Guid("de3f3369-3d51-4c17-929b-be4218c5b789"), "Instruction", "En cours d'instruction" },
                    { new Guid("e3f823ce-f5e9-4d4c-b1ee-7e960d722d6f"), "DevisValide", "Devis validé par client" },
                    { new Guid("e7a6e022-b1a0-4a02-b994-47613ff9f6b8"), "DevisRefuser", "Devis refusé par client" }
>>>>>>>> 29c72a208dcbd6c9b89c6421901fa84af8ef7d95:arpce-homologation-backOffice/Arpce.Homologation.BackOffice/BackOffice.Infrastructure/Migrations/20251202213245_Initialisation.cs
                });
...
<<<<<<<< HEAD:arpce-homologation-backOffice/Arpce.Homologation.BackOffice/BackOffice.Infrastructure/Migrations/20251202104745_InitialCreate.cs
                values: new object[] { new Guid("0f1d11bf-46d3-4633-8c9a-23615b4ecd7b"), null, true, "admin", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, false, null, new Guid("7e5b7d94-4f5d-4eff-9983-c8f846d3cee6"), "$2a$11$hl45SqHjw9MmxjK.n2gbmuqzts9XGfCcbbh1Zi5l1wL1qBCP5GqSW", "Administrateur", "ARPCE", null, "SYSTEM_SEED", null });
========
                values: new object[] { new Guid("bec01699-3434-4310-88a9-d64bf08ae841"), null, true, "admin", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, false, null, new Guid("7e5b7d94-4f5d-4eff-9983-c8f846d3cee6"), "$2a$11$51MqlIg9ogM0KLIekjNLJuf1S2dwfE1EezbTfQmbE1RWgz6cW/bJK", "Administrateur", "ARPCE", null, "SYSTEM_SEED", null });
