        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdminProfilId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdminUtilisateurs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdminUtilisateurs_AdminProfils_AdminProfilId",
                        column: x => x.AdminProfilId,
                        principalTable: "AdminProfils",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateIndex(
                name: "IX_AdminUtilisateurs_AdminProfilId",
                table: "AdminUtilisateurs",
                column: "AdminProfilId");
