    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("48200b35-3f9c-461b-a92c-4d72a7c679cb"), "MobileBanking", null, null, "Paiement mobile", (byte)1, null, null, null },
                    { new Guid("88869ffb-221b-4d03-b6bf-04ffe36640f2"), "Cheque", null, null, "Chèque", (byte)0, null, null, null },
                    { new Guid("96479709-5d83-4d76-af1b-260d29fca9e0"), "Virement", null, null, "Virement bancaire", (byte)0, null, null, null },
                    { new Guid("e304a789-72e3-4c4d-8238-d906555f49ee"), "Especes", null, null, "Espèces", (byte)0, null, null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("171456a1-2e36-4b30-b666-ace91c27dadf"), "NouvelleDemande", "Nouvelle demande" },
                    { new Guid("1a8b2b3c-d203-40ba-b055-a52ff9068023"), "EnvoyePourApprobation", "Envoyé pour approbation" },
                    { new Guid("34ba83c5-fce3-4e55-8ce1-7847eaaa64f7"), "EnCoursInstruction", "En cours d'instruction" },
                    { new Guid("3ea21147-4562-4401-bf59-12b6687779e6"), "ApprouveAttestationSignee", "Approuvé, attestation signée" },
                    { new Guid("4db099b8-c4a3-4403-9a0e-62df8ef0609b"), "Rejetee", "Rejetée" },
                    { new Guid("4eb98ba5-f479-459d-9fef-14484c579d56"), "AnnulationInstruction", "Annulation de l'instruction" },
                    { new Guid("60e5784d-dc08-4d09-a50c-6cb92e81397c"), "ApprouveAttentePaiement", "Approuvé, en attente de paiement" },
                    { new Guid("db66d770-46cb-41c6-b55b-140524f4fd3b"), "EquipementNonSoumisAHomologation", "Équipement non soumis à homologation" },
                    { new Guid("ef21fee2-6a50-4720-8ff2-ea34f6e2295c"), "ApprouvePaiementEffectue", "Approuvé, paiement effectué" }
                });
