    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
<<<<<<<< HEAD:arpce-homologation-frontOffice/FrontOffice.Infrastructure/Migrations/20251206141752_InitialCreate.cs
                    { new Guid("685f2103-b621-4960-9ae5-dbd236d9c53c"), "MobileBanking", null, null, "Paiement mobile", (byte)1, null, null, null },
                    { new Guid("abae475b-4bbe-482e-a3c3-6f0a8fb8a39a"), "Virement", null, null, "Virement bancaire", (byte)0, null, null, null },
                    { new Guid("c9eb67c7-1d96-483e-b60d-77bc0d2c4593"), "Especes", null, null, "Espèces", (byte)0, null, null, null },
                    { new Guid("d8fa333f-f101-4630-a7e0-d6deee470f93"), "Cheque", null, null, "Chèque", (byte)0, null, null, null }
========
...
>>>>>>>> 1a85d91ce2689cd6397687313df3f1bb615cb6f5:arpce-homologation-frontOffice/FrontOffice.Infrastructure/Migrations/20251206133420_Initialisation.cs
                });
            ...
            migrationBuilder.InsertData(
                ...
                {
<<<<<<<< HEAD:arpce-homologation-frontOffice/FrontOffice.Infrastructure/Migrations/20251206141752_InitialCreate.cs
                    { new Guid("08c53f08-3ae8-471e-820b-5e4aff3cd6e2"), "DevisCreer", "Devis créé" },
                    { new Guid("0a036a87-ca22-44d4-8c91-d8e6ea7dacab"), "DevisValideSC", "Devis validé par Chef Service" },
                    { new Guid("0aefb8fa-13b6-4d05-b651-504b70f74c6d"), "InstructionApprouve", "Instruction Approuvée" },
                    { new Guid("3370179a-d1ab-47c4-a9b4-3cf0e2ffbfdd"), "Instruction", "En cours d'instruction" },
                    { new Guid("4aa91259-375e-43c8-bfa5-d71c5a2cbde3"), "ApprobationInstruction", "Envoyé pour approbation" },
                    { new Guid("6086424b-a1d4-453f-82d2-e2db409d52a8"), "PaiementExpirer", "Paiement expiré" },
                    { new Guid("6a88e65b-ad86-4f0d-b0c0-861bebafb134"), "NouveauDossier", "Nouvelle demande" },
                    { new Guid("80b59ddc-8d18-4541-9fcc-fc191e947f00"), "PaiementRejete", "Paiement non accepté" },
                    { new Guid("89235ec6-e4a6-48f1-978d-78439dfd0838"), "DevisValideTr", "Devis validé par Trésorerie" },
                    { new Guid("9e794884-3e62-478a-a1af-25f138ce209d"), "RefusDossier", "Refus de la demande" },
                    { new Guid("a57e88cb-8d03-4788-9480-efaf905bf506"), "DossierSigner", "Attestation signée" },
                    { new Guid("b0e36360-8f46-4518-9190-76ed0cb1a9e0"), "DossierPayer", "Paiement effectué" },
                    { new Guid("b0f9bd85-86c8-4d7e-8971-764793650401"), "DevisValide", "Devis validé par client" },
                    { new Guid("b87cebf9-3712-402d-9b84-797d9d3eba9f"), "DevisRefuser", "Devis refusé par client" },
                    { new Guid("e69d8064-61b6-4068-a65c-c25c6cf838f2"), "DossierSignature", "Attestation en signature" },
                    { new Guid("fe75ed01-aabe-46ef-85d1-7eefac5eefe3"), "DevisEmit", "Devis émis" }
========
