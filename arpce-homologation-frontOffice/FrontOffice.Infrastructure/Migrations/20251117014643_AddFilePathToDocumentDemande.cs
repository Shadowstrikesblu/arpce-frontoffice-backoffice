...
{
    /// <inheritdoc />
    public partial class AddFilePathToDocumentDemande : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("16052aa3-482e-4a67-80a6-38adbce0864f"), "Especes", null, null, "Espèces", (byte)0, null, null, null },
                    { new Guid("24bb31ef-4243-4471-956c-6b44534e7501"), "MobileBanking", null, null, "Paiement mobile", (byte)1, null, null, null },
                    { new Guid("27b121a2-03ae-4b20-9cad-21af544824fc"), "Virement", null, null, "Virement bancaire", (byte)0, null, null, null },
                    { new Guid("c590dd66-7067-4549-9f5d-7a0bbc1fcb29"), "Cheque", null, null, "Chèque", (byte)0, null, null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("030921ac-356b-46f4-9ef2-b21840f694ca"), "NouvelleDemande", "Nouvelle demande" },
                    { new Guid("227218db-9b87-4b82-bf31-f99409eedb72"), "ApprouveAttestationSignee", "Approuvé, attestation signée" },
                    { new Guid("869212d0-cc27-4f97-bd57-e17d35aa46d5"), "EnCoursInstruction", "En cours d'instruction" },
                    { new Guid("96378b5c-5bd9-4655-8f46-4f9c4491563c"), "EquipementNonSoumisAHomologation", "Équipement non soumis à homologation" },
                    { new Guid("b2a0ef81-c550-497e-b369-87cf4683a693"), "EnvoyePourApprobation", "Envoyé pour approbation" },
                    { new Guid("bdde0bfc-6ac1-459d-848c-37f38ed6a4b7"), "ApprouvePaiementEffectue", "Approuvé, paiement effectué" },
                    { new Guid("ca805126-7f31-40b6-a8df-36ecd00c4cd4"), "AnnulationInstruction", "Annulation de l'instruction" },
                    { new Guid("ef617de4-ab04-4e72-8e93-23559880e49d"), "ApprouveAttentePaiement", "Approuvé, en attente de paiement" },
                    { new Guid("f282566c-c90e-4af8-a060-bded9c7da1c7"), "Rejetee", "Rejetée" }
                });
