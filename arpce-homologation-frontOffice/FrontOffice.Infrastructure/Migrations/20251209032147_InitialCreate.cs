    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0800525a-2444-4158-b78f-32819e173fa7"), "Virement", null, null, "Virement bancaire", (byte)0, null, null, null },
                    { new Guid("557137d3-bb68-4de0-91b5-8aba69ad52e4"), "Cheque", null, null, "Chèque", (byte)0, null, null, null },
                    { new Guid("cd485484-57a7-4d37-93bd-8d7f0b22d795"), "MobileBanking", null, null, "Paiement mobile", (byte)1, null, null, null },
                    { new Guid("f3e168a1-2cd2-4db4-be5f-47158f745c75"), "Especes", null, null, "Espèces", (byte)0, null, null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("2baa2511-c45c-4fd7-b725-48008821c882"), "DevisEmit", "Devis émis" },
                    { new Guid("372a740f-19d1-479b-a53e-672737aa74f9"), "InstructionApprouve", "Instruction Approuvée" },
                    { new Guid("4d084bc6-ce7d-4216-aa92-4cd985cdc3d0"), "PaiementRejete", "Paiement non accepté" },
                    { new Guid("5e6c0a16-567e-4b5a-87c5-3e5e4aee529f"), "DossierSigner", "Attestation signée" },
                    { new Guid("5f43ca07-b47e-45b7-a788-53c93bcf3603"), "Instruction", "En cours d'instruction" },
                    { new Guid("61509fa6-7d9e-40e7-b940-a89157158c38"), "DevisPaiement", "En attente de paiement" },
                    { new Guid("6dfa954a-b72d-4fcc-bc60-fb7d609bd691"), "ApprobationInstruction", "Envoyé pour approbation" },
                    { new Guid("79bdb275-c7ee-47d8-9160-b59a86e36211"), "DevisValideSC", "Devis validé par Chef Service" },
                    { new Guid("9144d4e7-03c4-478d-b059-2c634163e1e6"), "DevisValideTr", "Devis validé par Trésorerie" },
                    { new Guid("978f8286-466e-4add-b104-1bc451711f68"), "RefusDossier", "Refus de la demande" },
                    { new Guid("a09fe9ee-6def-4d05-8cf4-4e277e7071f6"), "DossierPayer", "Paiement effectué" },
                    { new Guid("b4bd8629-570a-4e02-bf18-c0ce5fbb6148"), "DossierSignature", "Attestation en signature" },
                    { new Guid("d51c4e48-8391-4c85-aa48-3a5ab52dc124"), "DevisValide", "Devis validé par client" },
                    { new Guid("e6ee4159-4eda-4ada-bb3a-55f41bbaf0f1"), "PaiementExpirer", "Paiement expiré" },
                    { new Guid("ec4d1c0a-dad3-405f-8289-10523f2f4118"), "DevisCreer", "Devis créé" },
                    { new Guid("f1c04ea9-b5c7-4253-8c14-16cfc780fba6"), "DevisRefuser", "Devis refusé par client" },
                    { new Guid("f8302226-ba5f-4b2e-a00d-de3b951d4827"), "NouveauDossier", "Nouvelle demande" }
                });
