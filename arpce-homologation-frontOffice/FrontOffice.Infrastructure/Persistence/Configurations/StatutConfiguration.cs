...
public class StatutConfiguration : IEntityTypeConfiguration<Statut>
{
    public void Configure(EntityTypeBuilder<Statut> builder)
    {
        ...
        builder.HasData(
            ...
            new Statut { Id = new Guid("5A6B7C8D-9E0F-1A2B-3C4D-5E6F70809000"), Code = "EnPaiement", Libelle = "Dossier en attente de paiement" },
            new Statut { Id = new Guid("11223344-5566-7788-99AA-BBCCDDEEFF00"), Code = "PaiementBanque", Libelle = "Dossier payé par la banque" },
            ...
            new Statut { Id = new Guid("AA11BB22-CC33-DD44-EE55-FF6600112233"), Code = "Certification", Libelle = "Certification initiée" },
            ...
            new Statut { Id = new Guid("17171717-1717-1717-1717-171717171717"), Code = "PaiementCaisse", Libelle = "Dossier payé à la caisse" }
        );
    }
}