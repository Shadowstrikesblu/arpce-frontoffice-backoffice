...
try
{
    ...
    // Accesseur au contexte HTTP (n�cessaire pour ICurrentUserService)
    ...
    // Base de donn�es avec SQL Server
    ...
    // Le middleware de gestion d'erreurs doit �tre l'un des premiers
